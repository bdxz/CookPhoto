...
public class TraceListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(inflater.inflate(R.layout.item_step_trace, parent, false));
    }
    ...
    public  class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            iv_stepPic = (ImageView)itemView.findViewById(R.id.iv_stepPic);
